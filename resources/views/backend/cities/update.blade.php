...
@section('title') {{trans('lang.update-city')}} @endsection
...
<!-- BEGIN: Subheader -->
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title ">{{ trans('lang.update-city') }}</h3>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <form id="modelForm" class="m-form m-form--fit m-form--label-align-right m-form--state" method="POST" action="{{route('update-city', ['id' => $city->id])}}" enctype="multipart/form-data">
                    @method('PATCH') 
                    @csrf
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group" id="name_arGroup">
                                ...
                                <input type="text" value="{{$city->name_ar}}" name="name_ar" class="form-control m-input m-input--square" id="name_ar" placeholder="{{trans('lang.name_ar')}}">
                            ...
                            <div class="form-group m-form__group" id="name_enGroup">
                                ...
                                <input type="text" value="{{$city->name_en}}" name="name_en" class="form-control m-input m-input--square" id="name_en" placeholder="{{trans('lang.name_en')}}">
