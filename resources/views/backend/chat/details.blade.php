			...
			<div class="m-widget3__item">
				<div class="m-widget3__header">
					<div class="m-widget3__user-img">
						@if($message->type == 3)
							<img class="m-widget3__img" src='{{asset("uploads/default.jpg")}}' alt="">
						@else
							<?php $image = $chat->client->image != null ? $chat->client->image : 'default.png'?>
...
<!--begin::Form-->
<form class="m-form m-form--fit m-form--label-align-right m-form--state" method="POST" action="{{route("backend.chat", ['id' => $chat->id])}}" id="modelForm">
