...
;(function ($) {
  ...
  function RateYo ($node, options) {
    ...
    function showRating (ratingVal) {
      ...
      percent = options.ltr ? 100 - percent : percent;
    ...
    function setNormalFill (newFill) {
      ...
      var $svgs = (options.ltr ? $ratedGroup : $normalGroup).find("svg");
    ...
    function setRatedFill (newFill) {
      ...
      var $svgs = (options.ltr ? $normalGroup : $ratedGroup).find("svg");
    ...
    function setltr (newValue) {

      newValue = !!newValue;

      options.ltr = newValue;
