    ...
    <div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <a href="{{url('providers/notifications/delete')}}" class="btn btn-danger m-btn m-btn--icon">{{ trans('lang.delete') }}</a>
                        <!--begin: Datatable -->
                    </div>  
            ...
            @if(LaravelLocalization::getCurrentLocale() == 'ar')
                swal({
                    ...
                    function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url("/providers/notifications/delete/data")}}" + "/" + id,
