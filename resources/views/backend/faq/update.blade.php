...
@section('title') {{trans('lang.update-faq')}} @endsection
...
<!-- BEGIN: Subheader -->
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title ">{{ trans('lang.update-faq') }}</h3>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <form id="modelForm" class="m-form m-form--fit m-form--label-align-right m-form--state" method="POST" action="{{route('update-faq', ['id' => $faq->id])}}" enctype="multipart/form-data">
                    @method('PATCH') 
                    @csrf
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group" id="title_arGroup">
                                ...
                                <input type="text" value="{{$faq->title_ar}}" name="title_ar" class="form-control m-input m-input--square" id="title_ar" placeholder="{{trans('lang.title_ar')}}">
                            ...
                            <div class="form-group m-form__group" id="title_enGroup">
                                ...
                                <input type="text" value="{{$faq->title_en}}" name="title_en" class="form-control m-input m-input--square" id="title_en" placeholder="{{trans('lang.title_en')}}">
                            ...
                            <div class="form-group m-form__group" id="description_arGroup">
                                ...
                                <textarea rows="10"  name="description_ar" class="form-control m-input m-input--square" id="description_ar" placeholder="{{trans('lang.description_ar')}}">{{$faq->description_ar}}</textarea>
                            ...
                            <div class="form-group m-form__group" id="description_enGroup">
                                ...
                                <textarea rows="10"  name="description_en" class="form-control m-input m-input--square" id="description_en" placeholder="{{trans('lang.description_en')}}">{{$faq->description_en}}</textarea>
