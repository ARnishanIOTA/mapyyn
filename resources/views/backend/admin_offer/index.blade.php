...
@section('title') {{trans('lang.admin_offers')}} @endsection
...
<!-- BEGIN: Subheader -->
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title ">{{ trans('lang.admin_offers') }}</h3>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('lang.admin_offer_from') }}</th>
                                    <th>{{ trans('lang.admin_offer_to') }}</th>
            ...
            @if(LaravelLocalization::getCurrentLocale() == 'ar')
                swal({
                    ...
                    function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url("/backend/admin-offers/delete")}}" + "/" + id,
