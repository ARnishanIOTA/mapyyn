...
@section('title') {{trans('lang.subscribes')}} @endsection
...
<!-- BEGIN: Subheader -->
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title ">{{ trans('lang.subscribes') }}</h3>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                            ...
                            <tbody>
                                ...
                                <tr id="{{$subscribe->id}}">
                                    ...
                                    <td>
                                        <a href="{{route('reply', ['id' => $subscribe->id])}}" class="btn btn-success m-btn m-btn--icon">
                                            <span><span>{{trans('lang.reply')}}</span></span>
                                        </a>
                                        <a href="" data-id="{{ $subscribe->id }}" class="btn btn-danger delete-button m-btn m-btn--icon">
            ...
            @if(LaravelLocalization::getCurrentLocale() == 'ar')
                swal({
                    ...
                    function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url("/backend/subscribes/delete")}}" + "/" + id,
