...
<!-- BEGIN: Subheader -->
    {{--  <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title ">{{ trans('lang.clients') }}</h3>
            </div>
        </div>
    </div>  --}}
                    ...
                    <div class="m-portlet__head-tools">
                        <ul class="m-portlet__nav">
                            <li class="m-portlet__nav-item">
                                <button onclick="window.location.href='{{route('admin.downloads.clients')}}'" id="export_data" class="btn btn-primary">
                                    <span>
            ...
            @if(LaravelLocalization::getCurrentLocale() == 'ar')
                swal({
                    ...
                    function() {
                        $.ajax({
                            type: "GET",
                            url: "{{url("/backend/clients/delete")}}" + "/" + id,
