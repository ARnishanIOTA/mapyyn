...
@section('title') {{ trans('lang.providerRegistration') }} @endsection
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-5">
						<h4 class="active text-center"> {{ trans('lang.providerRegistration') }} </h4>
					</div>
					<div class="col-md-12">
						<div class="booking-content">
							<form method="POST" action="{{route('providerRegistration')}}" id="modelForm">
								@csrf
								<div class="row">
									<div class="col-md-12">
									...
									<div class="col-md-6">
										...
										<div class="form-group mb-4">
											<input name="address" type="text" class="form-control" placeholder="{{ trans('lang.address') }}">
										</div>
									</div>
								</div>
